      ...
      <section className="px-6 pb-12 max-w-[1160px] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
          ...
          <div className="bg-white rounded-[28px] shadow-[0px_16px_32px_0px_rgba(27,28,28,0.1)] p-8 md:p-10">
            ...
            <button className="w-full h-[54px] bg-[#f5f3f3] hover:bg-[#eae8e8] rounded-[18px] font-semibold text-[#1b1c1c] text-[15px] transition-colors">
              Start with Core
            </button>
          </div>
          ...
          <div className="bg-[#1b1c1c] border-2 border-[rgba(248,118,0,0.55)] rounded-[28px] shadow-[0px_16px_32px_0px_rgba(27,28,28,0.1)] p-8 md:p-10 relative">
            ...
            <button className="w-full h-[54px] bg-[#4f40cf] hover:bg-[#3d31a8] shadow-[0px_10px_20px_0px_rgba(54,32,184,0.16)] rounded-[18px] font-semibold text-white text-[15px] transition-colors">
              Scale My Business
            </button>
          </div>
        </div>
        ...
        <div className="flex justify-center mt-8">
          <button className="h-[48px] px-8 bg-[#f5f3f3] hover:bg-[#eae8e8] rounded-[24px] shadow-[0px_8px_18px_0px_rgba(27,28,28,0.04)] font-semibold text-[#1b1c1c] text-[15px] transition-colors">
            View All Features
          </button>
        </div>
      </section>
      ...
      <section className="px-6 pb-16 max-w-[1160px] mx-auto">
        <div className="bg-[#4f40cf] rounded-[34px] shadow-[0px_18px_36px_0px_rgba(54,32,184,0.18)] px-8 md:px-16 py-14 text-center relative overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 relative z-10">
            <button className="bg-white text-[#3620b8] font-semibold text-[14px] px-7 h-[50px] rounded-[25px] shadow-[0px_10px_20px_0px_rgba(27,28,28,0.08)] hover:bg-gray-50 transition-colors w-full sm:w-auto">
              Start with Core
            </button>
            <button className="bg-[#f87600] text-white font-semibold text-[14px] px-7 h-[50px] rounded-[25px] shadow-[0px_10px_20px_0px_rgba(248,118,0,0.12)] hover:bg-[#d96800] transition-colors w-full sm:w-auto">
              Scale My Business
            </button>
          </div>
        </div>
